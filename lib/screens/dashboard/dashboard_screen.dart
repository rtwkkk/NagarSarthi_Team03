...
import 'package:nagar_alert_app/providers/theme_provider.dart' hide Colors;
...
class _DashboardScreenState extends State<DashboardScreen> {
        ...
        return Scaffold(
            ...
            builder: (context, snapshot) {
              ...
              final recentIncidents = incidents.where((doc) {
                ...
                return timestamp != null &&
                    timestamp.toDate().isAfter(twoHoursAgo);
              }).toList();
              ...
              final monthlyIncidents = incidents.where((doc) {
                ...
                return date.isAfter(_startOfMonth) &&
                    date.isBefore(_endOfMonth);
              }).toList();
              ...
              if (resolvedIncidentsThisMonth.isNotEmpty) {
                ...
                for (var doc in resolvedIncidentsThisMonth) {
                  ...
                  if (resolved != null) {
                    final duration = resolved.toDate().difference(
                      created.toDate(),
                    );
              ...
              if (avgResponseMinutes < 60) {
                displayTime =
                    '${avgResponseMinutes.toStringAsFixed(1)} minutes';
              } else {
                    ...
                    recentIncidents.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final doc = recentIncidents[index];
                              final data = doc.data() as Map<String, dynamic>;
                              final String title =
          ...
          floatingActionButton: Container(
            ...
            child: FloatingActionButton.extended(
              ...
              elevation: 0,
              icon: Icon(Icons.add_alert, color: theme.colorScheme.onPrimary),
              label: const Text(
                'Report Incident',
                style: TextStyle(
                  fontWeight: FontWeight.w700,
  ...
  Widget _buildIncidentMetric(IconData icon, String text, bool isDark) {
    return Row(
      children: [
        Icon(
          icon,
