...
import { Layers, Construction, Building2, ShieldAlert, HeartPulse, Activity, Trash2, MapPin, Brain } from 'lucide-react';
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center gap-2">
                                <div className={`w-7 h-7 ${layer.color} rounded-full shadow-sm flex items-center justify-center`}>
